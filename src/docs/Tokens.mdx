...
See **Foundations / Typography** for the full role split (Hanken Grotesk for prose, Work Sans for UI, Fraunces for editorial display, Fira Code for technical content).
