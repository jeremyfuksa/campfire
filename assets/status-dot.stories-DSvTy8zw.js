import{a as e,n as t}from"./chunk-BneVvdWh.js";import{t as n}from"./react-XedgCGTy.js";import{t as r}from"./jsx-runtime-_akqGrVk.js";import{n as i,t as a}from"./utils-CDLLjGU_.js";var o,s,c,l,u=t((()=>{o=e(n(),1),i(),s=r(),c={success:`bg-(--success-600)`,warning:`bg-(--warning-600)`,danger:`bg-(--danger-600)`,error:`bg-(--danger-600)`,info:`bg-(--info-600)`,neutral:`bg-(--neutral-500)`,default:`bg-(--neutral-500)`,active:`bg-(--success-500)`,away:`bg-(--warning-500)`,offline:`bg-(--neutral-400)`},l=o.forwardRef(({status:e,variant:t,label:n,pulse:r=!1,className:i},o)=>{let l=c[t??e??`neutral`]??c.neutral;return(0,s.jsxs)(`div`,{ref:o,className:a(`inline-flex items-center gap-2`,i),children:[(0,s.jsxs)(`div`,{className:`relative`,children:[(0,s.jsx)(`div`,{className:a(`w-2 h-2 rounded-full`,l)}),r&&(0,s.jsx)(`div`,{className:a(`absolute inset-0 w-2 h-2 rounded-full animate-ping opacity-75`,l)})]}),n&&(0,s.jsx)(`span`,{className:`text-sm text-(--text-primary)`,children:n})]})}),l.displayName=`StatusDot`,l.__docgenInfo={description:``,methods:[],displayName:`StatusDot`,props:{variant:{required:!1,tsType:{name:`union`,raw:`| "success"
| "warning"
| "error"
| "danger"
| "info"
...
}`,...b.parameters?.docs?.source}}},x=[`Success`,`Warning`,`Error`,`Info`,`Default`,`AllStatuses`,`InList`,`UserStatus`]}))();export{v as AllStatuses,_ as Default,h as Error,y as InList,g as Info,p as Success,b as UserStatus,m as Warning,x as __namedExportsOrder,f as default};