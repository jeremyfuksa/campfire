...
const SheetOverlay = React.forwardRef(({ className, ...props }, ref) => {
    return (_jsx(SheetPrimitive.Overlay, { ref: ref, "data-slot": "sheet-overlay", className: cn("data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/50", className), ...props }));
});
