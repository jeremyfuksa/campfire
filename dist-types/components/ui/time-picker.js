...
export function TimePicker({ value = "", onChange, placeholder = "Select time", disabled = false, className, use24Hour = false, minuteStep = 1, }) {
    ...
    return (_jsxs("div", { className: cn("flex items-center gap-2", className), children: [_jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Input, { type: "text", value: hours, onChange: handleHoursChange, onKeyDown: (e) => handleKeyDown(e, "hours"), placeholder: "HH", disabled: disabled, className: "w-16 text-center", maxLength: 2 }), _jsx("span", { className: "text-muted-foreground", children: ":" }), _jsx(Input, { type: "text", value: minutes, onChange: handleMinutesChange, onKeyDown: (e) => handleKeyDown(e, "minutes"), placeholder: "MM", disabled: disabled, className: "w-16 text-center", maxLength: 2 })] }), !use24Hour && (_jsx("button", { type: "button", onClick: handlePeriodToggle, disabled: disabled, className: cn("border-input hover:bg-accent hover:text-accent-foreground", "rounded-md border px-3 py-2 text-sm font-medium transition-colors", "disabled:cursor-not-allowed disabled:opacity-50"), children: period }))] }));
}
